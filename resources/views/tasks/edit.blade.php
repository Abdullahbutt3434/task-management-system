    ...
    <div class="bg-light rounded h-100 p-4">
        ...
        <form action="{{ route('tasks.update') }}" method="POST" id="createTask">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInputName" name="name" value="{{ $task->name }}" placeholder=" Task Name">
                ...
                <div class="col-sm-6 ">
                    <div class="form-floating mb-3">
                        <select class="form-select" id="floatingSelectUser" name="user_id" value="{{ $task->user->id }}" aria-label=" Select User to Assign">
            ...
            <div class="row">
                <div class="col-sm-6 ">
                    <div class="form-floating mb-3">
                        <input type="text" readonly class="form-control" id="start" name="start" value="{{ $task->start }}" placeholder=" Start Date Time" autocomplete="off">
                        <label for="start">Start Date Time</label>
                    </div>
                </div>
                <div class="col-sm-6 ">
                    <div class="form-floating mb-3">
                        <input type="text" readonly class="form-control" id="end" name="end" value="{{ $task->end }}" placeholder=" End Date Time" autocomplete="off">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="pro" name="priority" value="{{ $task->priority }}" placeholder=" Enter Priority" autocomplete="off">
